    ...
    <div className="atelier-details">
      ...
      <div className="content">
        ...
        <div className="section-image">
          <img src="algorithmes.webp" alt="Technologies pour Seniors" />
        </div>
        ...
        <div className="section-image">
          <img src="seniors-using-tech.webp" alt="Seniors utilisant des technologies" />
        </div>
        ...
        <div className="section-image">
          <img src="seniors-workshop.webp" alt="Atelier pour Seniors" />
        </div>
